...
class Restaurant(models.Model):
    ...
    image = models.ImageField(storage=custom_storage, blank=True, null=True, default='666c927c0021620424da')
...
class MenuItem(models.Model):
    ...
    image = models.ImageField(storage=custom_storage, blank=True, null=True, default='666c9126003710f4443a')
